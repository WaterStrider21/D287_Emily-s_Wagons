...
class PartTest {
    ...
    public void GetAndSetMin() {
        ...
        // For outsourced parts
        partOut.setMinInv(min);
        assertEquals(min, partOut.getMinInv(), "Inventory incorrect!");
    }

    public void GetAndSetMax() {
        int max = 5;

        // For inhouse parts
        partIn.setMaxInv(max);
        assertEquals(max, partIn.getMaxInv(), "Inventory incorrect!");

        // For outsourced parts
        partOut.setMinInv(max);
        assertEquals(max, partOut.getMaxInv(), "Inventory incorrect!");
    }
}
