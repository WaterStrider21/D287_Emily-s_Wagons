...
public abstract class Part implements Serializable {
    ...
    static int minInv = 1;
    @Max(value = 45, message = "Maximum inventory value must fall within set maximum")
   static int maxInv = 45;
    ...
    public static boolean checkInventory(int inv) {
